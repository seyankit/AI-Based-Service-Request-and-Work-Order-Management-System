...
Progress fields belong to Phase 5.
...
Reassignment may become Phase 4B.2 if implementation risk is significantly larger than initial assignment.
...
Expected schema/policy lifecycle:
